...
<template>
    <div class="drive-card" :class="`drive-card--${tempState}`">
        ...
        <div class="dc-header">
            ...
            <button class="dc-reset-btn" title="Reset peak values" @click="resetPeaks">
                ↺ Peaks
            </button>
        </div>
            ...
            <div class="dc-metric">
                <div class="dc-metric-top">
                    ...
                    <div class="dc-value-row">
                        ...
                        <span v-if="peakVoltage != null" class="dc-peak"
                            >↑{{ fmt(peakVoltage) }}</span
                        >
                    </div>
                </div>
                <Sparkline
            ...
            <div class="dc-metric">
                <div class="dc-metric-top">
                    ...
                    <div class="dc-value-row">
                        ...
                        <span v-if="peakCurrent != null" class="dc-peak"
                            >↑{{ fmt(peakCurrent) }}</span
                        >
                    </div>
                </div>
                <Sparkline
