...
export default class Publisher<T extends TopicType> {
   ...
   */
  // wraps in {} because it will be backward compatibility when adding new parameters as normal parameter, that would require changing modifying everywhere that it is called
