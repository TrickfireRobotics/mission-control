...
function motorCanId(position: string, side: string): number {
  return (
    drivetrainMotors.find((m) => m.displayName.includes(position) && m.displayName.includes(side))
      ?.canfdID ?? 0
  );
}
          ...
          <div class="schematic-wrapper">
            ...
            >
              ...
              <rect
                ...
                height="62"
                rx="5"
                :style="{ fill: wheelFill(schematicIds.FL), stroke: wheelStroke(schematicIds.FL) }"
                stroke-width="1.5"
              />
              <text
                x="28"
              ...
              <rect
                ...
                height="62"
                rx="5"
                :style="{ fill: wheelFill(schematicIds.ML), stroke: wheelStroke(schematicIds.ML) }"
                stroke-width="1.5"
              />
              <text
                x="28"
              ...
              <rect
                ...
                height="62"
                rx="5"
                :style="{ fill: wheelFill(schematicIds.BL), stroke: wheelStroke(schematicIds.BL) }"
                stroke-width="1.5"
              />
              <text
                x="28"
              ...
              <rect
                ...
                height="62"
                rx="5"
                :style="{ fill: wheelFill(schematicIds.FR), stroke: wheelStroke(schematicIds.FR) }"
                stroke-width="1.5"
              />
              <text
                x="142"
              ...
              <rect
                ...
                height="62"
                rx="5"
                :style="{ fill: wheelFill(schematicIds.MR), stroke: wheelStroke(schematicIds.MR) }"
                stroke-width="1.5"
              />
              <text
                x="142"
              ...
              <rect
                ...
                height="62"
                rx="5"
                :style="{ fill: wheelFill(schematicIds.BR), stroke: wheelStroke(schematicIds.BR) }"
                stroke-width="1.5"
              />
              <text
                x="142"
