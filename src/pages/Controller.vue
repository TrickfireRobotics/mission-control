                ...
                <div v-if="snapshot" class="ctrl-viz">
                    ...
                    <div class="top-row">
                        ...
                        <div class="centre-top">
                            ...
                            <div class="centre-btn xbox-btn" :class="{ active: btnPressed(16) }">
                                ⊙
                            </div>
                                    ...
                                    <template v-if="row.isAxis">
                                        <div class="bar-track bar-track--axis">
                                            <div
                                                class="bar-neg"
                                                :style="{
                                                    width: `${Math.max(0, -row.live) * 50}%`,
                                                }"
                                            />
                                            <div class="bar-centre" />
                                            <div
                                                class="bar-pos"
                                                :style="{ width: `${Math.max(0, row.live) * 50}%` }"
                                            />
                                        </div>
                                    </template>
                                    <template v-else>
                                        <div class="bar-track">
                                            <div
                                                class="bar-pos bar-pos--full"
                                                :style="{ width: `${row.live * 100}%` }"
                                            />
                                        </div>
                                    </template>
